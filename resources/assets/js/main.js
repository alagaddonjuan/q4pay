...
const loadImg = () => {
  if (document.documentElement.classList.contains('dark')) {
    logoFull.setAttribute('src', `${currentUrl}/assets/images/logo-with-text.png`);
    logoFull2.setAttribute('src', `${currentUrl}/assets/images/logo-with-text.png`);
    logoIcon.setAttribute('src', `${currentUrl}/assets/images/logo.png`);
    logoText.setAttribute('src', `${currentUrl}/assets/images/logo-text.png`);
    qrCodeImg && qrCodeImg.setAttribute('src', `${currentUrl}/assets/images/qrcode.png`);
  } else {
    logoFull.setAttribute('src', `${currentUrl}/assets/images/logo-with-text-dark.png`);
    logoFull2.setAttribute('src', `${currentUrl}/assets/images/logo-with-text-dark.png`);
    logoIcon.setAttribute('src', `${currentUrl}/assets/images/logo-dark.png`);
    logoText.setAttribute('src', `${currentUrl}/assets/images/logo-text-dark.png`);
    qrCodeImg && qrCodeImg.setAttribute('src', `${currentUrl}/assets/images/qrcode-dark.png`);
  }
};
