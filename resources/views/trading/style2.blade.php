...
@section('content')
    <div class="main-inner">
        ...
        <div class="grid grid-cols-12 gap-4 xxl:gap-6">
            <!-- Statistics -->
            <div class="col-span-12 lg:col-span-6 xxl:col-span-7 3xl:col-span-6">
                <div class="grid grid-cols-2 gap-4 xxl:gap-6">
                    <div class="col-span-2 sm:col-span-1 lg:col-span-2 xxl:col-span-1 box p-3 md:p-4 3xl:px-8 3xl:py-6">
                        <div class="flex items-center justify-between bb-dashed mb-4 pb-4 3xl:">
            ...
            <!-- USD to EUR chart -->
            <div class="col-span-12 lg:col-span-6 xxl:col-span-5 3xl:col-span-6">
