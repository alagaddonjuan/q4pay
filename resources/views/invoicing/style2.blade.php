        ...
        <div class="grid grid-cols-12 gap-4 xxl:gap-6 mb-4 lg:mb-6">
            ...
            <div class="box col-span-12 bg-n0  min-[650px]:col-span-6 3xl:col-span-3">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div
                        class="-my-3 shrink-0 ltr:translate-x-3 xl:ltr:translate-x-7 3xl:ltr:translate-x-2 4xl:ltr:translate-x-9 rtl:-translate-x-3 xl:rtl:-translate-x-7 3xl:rtl:-translate-x-2 4xl:rtl:-translate-x-9">
        ...
        <div class="box">
            <div class="flex flex-wrap gap-4 justify-between items-center bb-dashed mb-4 pb-4 3xl:">
                ...
                <div class="flex items-center max-lg:flex-wrap gap-4">
                    ...
                    <div class="rounded-[32px] bg-primary/5 border border-n30  flex invoice-btns">
                        <button class="font-medium text-xs px-4 sm:px-5 3xl:px-6 py-3 invoice-active">
                            All
                        </button>
                        <button class="font-medium text-xs px-4 sm:px-5 3xl:px-6 py-3 ">
                            Paid
                        </button>
                        <button class="font-medium text-xs px-4 sm:px-5 3xl:px-6 py-3 ">
                            Unpaid
