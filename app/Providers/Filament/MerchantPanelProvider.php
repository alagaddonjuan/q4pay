...
class MerchantPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ->id('merchant')
            ->path('merchant') // 🟢 FIXED: Clean, professional URL routing
            ->brandName('Q4I Corporate Dashboard') // 🟢 ADDED: Enterprise Branding
            ->login()
            ->registration(\App\Filament\Pages\Auth\Register::class)
            
            // ==========================================
            // 🟢 CRITICAL: MULTI-AUTH GUARD ENFORCEMENT
            // ==========================================
            // This strictly locks the panel to the `merchants` table.
            // Vendors (Users) cannot access this portal.
            ->authGuard('merchant') 
            ->authPasswordBroker('merchants') 
            
            ->colors([
                'primary' => Color::Blue, // Shifted from default Amber to a corporate Fintech Blue
            ])
